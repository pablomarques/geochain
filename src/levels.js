/**
 * Inverted Velocity Difficulty Curve
 * Fast bodies in early levels for high encounter rates & easy clears;
 * Slow, deliberate bodies in late levels requiring strategic ember bridging & vortex clustering.
 */
...
export const CAMPAIGN_LEVELS = [
  {
    ...
    stars: [1, 3, 5],
    totalParticles: 8,
    baseSpeed: 4.6, // Fast velocity: 8 bodies quickly zip into your blast!
  ...
  },
  {
    ...
    stars: [50, 62, 70],
    totalParticles: 75,
    baseSpeed: 1.1, // Glacial Precision
